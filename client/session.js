...
export function createSession() {
  const state = {
    ...
    attackTimer: 0, attackTargetId: null, attackTargetX: 0, attackTargetY: 0, hurtTimer: 0, hurtStrength: 0, lastForgeAssistHeat: 0,
  };
  ...
  return { state, note, mapPoint, roomPlayerCount, gameReady, abilities, relics, activeEntities, joinRoom, interact, handleGameKey, handleGameClick, handleGamePointerDown, handleGamePointerMove, handleGamePointerUp, update };
}
