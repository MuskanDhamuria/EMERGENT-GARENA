...
export const FINALE_VARIANTS = Object.freeze({
  lantern_rite: Object.freeze({ title: 'Lantern Rite', description: 'Defend a central energy core through adaptive enemy waves, repair it between assaults, then synchronize four switches.' }),
...
export function applyDirectorDirective(world, room, directive, options = {}) {
  ...
  if (card === 'finale_variant') {
    ...
    const applied = typeof world.setFinaleVariant === 'function' ? world.setFinaleVariant(room, payload.variantId, source) : { ok:true };
