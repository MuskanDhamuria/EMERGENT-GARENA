...
export function createMcpRouter(world) {
  return async function handleMcpApi(request, response, pathname) {
    ...
    else if (pathname === '/api/mcp/loner-missions') { world.markGmActive(room); result = world.chooseLonerMissions(room, payload.playerId, payload.missionIds, payload.reason, 'MCP Game Master'); }
